...
et_w3_data <- et_w3_data  %>%
  select(household_id2, rural, pw_w3, individual_id2, ea_id2, region, zone, woreda, town, subcity, kebele, ea, hh, u_5, weight_kg, height_cm,
         birth_month, birth_year, age, age_months, female, hh_s1q03, age_days, latitude, longitude)
...
```{r set_up_spatial_map}

nb.r <- poly2nb(et_admin1_map, queen=F)    #couldn't put rownames here - do I need those?
